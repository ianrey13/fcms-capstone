...
class TripTicket extends Model
{
    ...
    protected $fillable = [
        'trip_ticket_number', 'department_id', 'driver_id', 'vehicle_id',
        'submitted_by', 'created_by_mo_user_id', 'submitted_by_head',
        'submitted_at', 'trip_date', 'purpose', 'destination',
        'charge_to', 'passenger_name', 'status', 'updated_at',
